...
export default function UserProfilePage() {
  ...
  const getPlatformIcon = (platform: string): IconType => {
    const icons: Record<string, IconType> = {
      ...
      viber: Phone,
      wechat: PlatformIcons.WeChatIcon,
      line: PlatformIcons.LineIcon,
      
      // E-ticaret & Satış
      etsy: PlatformIcons.EtsyIcon,
      ebay: PlatformIcons.EbayIcon,
      shopify: PlatformIcons.ShopifyIcon,
      trendyol: PlatformIcons.TrendyolIcon,
      hepsiburada: PlatformIcons.HepsiburadaIcon,
      temu: PlatformIcons.TemuIcon,
      aliexpress: PlatformIcons.AliExpressIcon,
      sahibinden: PlatformIcons.SahibindenIcon,
      gittigidiyor: PlatformIcons.GittigidiyorIcon,
      n11: PlatformIcons.N11Icon,
      
      // Ödeme
      paypal: CreditCard,
      cashapp: DollarSign,
      venmo: DollarSign,
      revolut: PlatformIcons.RevolutIcon,
      wise: PlatformIcons.WiseIcon,
      papara: PlatformIcons.PaparaIcon,
      
      // Müzik & Video
      soundcloud: PlatformIcons.SoundCloudIcon,
      bandcamp: PlatformIcons.BandcampIcon,
      applemusic: PlatformIcons.AppleMusicIcon,
      deezer: PlatformIcons.DeezerIcon,
      vimeo: PlatformIcons.VimeoIcon,
      dailymotion: PlatformIcons.DailymotionIcon,
      rumble: PlatformIcons.RumbleIcon,
      kick: PlatformIcons.KickIcon,
      
      // Sosyal & Diğer
      clubhouse: PlatformIcons.ClubhouseIcon,
      
      // Profesyonel
      gitlab: PlatformIcons.GitLabIcon,
      dribbble: Dribbble,
      medium: FileText,
      devto: PlatformIcons.DevToIcon,
      stackoverflow: PlatformIcons.StackOverflowIcon,
      figma: PlatformIcons.FigmaIcon,
      notion: PlatformIcons.NotionIcon,
      calendly: FileText,
      linktree: Link2,
      substack: PlatformIcons.SubstackIcon,
      patreon: PlatformIcons.PatreonIcon,
      kofi: PlatformIcons.KoFiIcon,
      buymeacoffee: PlatformIcons.BuyMeACoffeeIcon,
      
      // Profesyonel Ağlar
      xing: PlatformIcons.XingIcon,
      angellist: PlatformIcons.AngelListIcon,
      crunchbase: PlatformIcons.CrunchbaseIcon,
      producthunt: PlatformIcons.ProductHuntIcon,
      
      // Rezervasyon
      booking: PlatformIcons.BookingIcon,
      airbnb: PlatformIcons.AirbnbIcon,
      tripadvisor: PlatformIcons.TripAdvisorIcon,
      uber: PlatformIcons.UberIcon,
      bolt: PlatformIcons.BoltIcon,
    };
